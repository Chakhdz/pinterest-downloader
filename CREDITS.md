...
**Product name:** Pinterest GUI Downloader (CHK).

- Engine: [limkokhole/pinterest-downloader](https://github.com/limkokhole/pinterest-downloader), MIT License, Copyright (c) 2020 limkokhole@gmail.com. See `LICENSE`.
